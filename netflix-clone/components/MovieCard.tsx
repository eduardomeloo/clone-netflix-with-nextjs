    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            ...
            <div className="opacity-0 absolute top-0 transition duration-200 z-10 invisible
                sm:visible delay-300 w-full scale-0 group-hover:scale-110 
                group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] 
                group-hover:opacity-100">

                <img className="cursor-pointer object-cover transition duration shadow-xl 
                ...
                <div className="z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full
                    ...
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <div 
                            ...
                            className="cursor-pointer ml-auto group/item w-6 h-6 lg:w-10 
